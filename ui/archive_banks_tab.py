...
from services.banks import (
    get_deleted_banks, restore_bank, delete_banks_forever
)


class ArchiveBanksTab(QWidget):
    ...
    def restore_selected(self) -> None:
        ...
        for bid in ids:
            try:
                ...
                self._msg(f"Не удалось восстановить {bid}: {e}", "error", 6000)
        self.load_data()
